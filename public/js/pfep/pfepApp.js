/* pfepApp.js — PFEP Register page bootstrap.
 *
 * Lightweight initialiser for PFEP pages.  Wires shared functionality
 * (icons, auth, support modal) and provides a namespace for future
 * PFEP-specific modules.
 *
...
(function () {
  ...
  // ── Auth initialisation (shared pattern from procurementApp.js) ───────────
