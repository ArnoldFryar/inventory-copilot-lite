...
const { hasProAccess } = require('./server/lib/planAccess');
...
// ---------------------------------------------------------------------------
// POST /api/billing/checkout  (and canonical alias /create-checkout-session)
// POST /api/billing/portal    (and canonical alias /create-portal-session)
// ---------------------------------------------------------------------------
app.post('/api/billing/checkout',               requireAuth, createCheckoutSession);
app.post('/api/billing/create-checkout-session', requireAuth, createCheckoutSession);
app.post('/api/billing/portal',                 requireAuth, createPortalSession);
app.post('/api/billing/create-portal-session',  requireAuth, createPortalSession);
